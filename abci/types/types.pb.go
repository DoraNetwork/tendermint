...
type BlockSize struct {
	MaxTxsBytes          int32    `protobuf:"varint,1,opt,name=max_txs_bytes,json=maxTxsBytes,proto3" json:"max_txs_bytes,omitempty"`
...
func (m *BlockSize) GetMaxTxsBytes() int32 {
	if m != nil {
		return m.MaxTxsBytes
	}
	return 0
}
...
func (this *BlockSize) Equal(that interface{}) bool {
	...
	if this.MaxTxsBytes != that1.MaxTxsBytes {
		return false
	}
...
func (m *BlockSize) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.MaxTxsBytes != 0 {
		dAtA[i] = 0x8
		i++
		i = encodeVarintTypes(dAtA, i, uint64(m.MaxTxsBytes))
	}
	if m.MaxGas != 0 {
		dAtA[i] = 0x10
		i++
...
func NewPopulatedBlockSize(r randyTypes, easy bool) *BlockSize {
	this := &BlockSize{}
	this.MaxTxsBytes = int32(r.Int31())
	if r.Intn(2) == 0 {
		this.MaxTxsBytes *= -1
	}
...
func (m *BlockSize) Size() (n int) {
	...
	_ = l
	if m.MaxTxsBytes != 0 {
		n += 1 + sovTypes(uint64(m.MaxTxsBytes))
	}
	if m.MaxGas != 0 {
...
func (m *BlockSize) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field MaxTxsBytes", wireType)
			}
			m.MaxTxsBytes = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MaxTxsBytes |= (int32(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
>>>>>>> remove ConsensusParams#BlockSize#MaxTxs
func init() {
	golang_proto.RegisterFile("abci/types/types.proto", fileDescriptor_types_3cb405650ad72081)
}

var fileDescriptor_types_3cb405650ad72081 = []byte{
